      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-[#0a2540] via-[#1e3a5a] to-[#0a2540] text-white px-6 py-24 overflow-hidden">
          ...
          >
            ...
            <h1 className="text-6xl font-extrabold leading-tight">Complete Digital<br/>Solutions for Your Business</h1>
        ...
        <section className="px-6 py-20">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl font-extrabold text-zinc-900 mt-2">Services Designed for Results</h2>
        ...
        <section className="bg-white px-6 py-20 border-t border-zinc-100">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl font-extrabold text-zinc-900 mt-2">How We Deliver Excellence</h2>
        ...
        <section className="px-6 py-20">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-amber-500 font-semibold tracking-wider text-sm">Why JP Technologies</p>
              <h2 className="text-4xl font-extrabold text-zinc-900 mt-2">We Don&apos;t Just Build — We Deliver Results</h2>
            </motion.div>
