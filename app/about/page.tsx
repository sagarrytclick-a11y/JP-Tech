...
const stats = [
  ...
  { icon: FaUsers, label: "Team Members", value: "60+" },
  { icon: FaGlobe, label: "Clients Served", value: "500+" },
  { icon: FaRocket, label: "Projects Delivered", value: "1000+" },
];
...
const timeline = [
  { year: "2012", title: "The Beginning", desc: "Abhishek Tiwari started JP Technologies with a vision to help small businesses go digital." },
  { year: "2015", title: "Team Expansion", desc: "Grew to 15+ team members and launched our social media marketing division." },
  { year: "2018", title: "500+ Clients", desc: "Crossed the 500-client milestone and expanded into SEO and PPC services." },
  { year: "2021", title: "Full-Scale Agency", desc: "60+ experts across web dev, design, marketing, and content working as one unit." },
  { year: "2025", title: "Award-Winning", desc: "Recognized as a top-rated digital agency with 1000+ successful projects delivered." },
];
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-[#0a2540] via-[#1e3a5a] to-[#0a2540] text-white px-6 py-24 overflow-hidden">
          ...
          >
            ...
            <h1 className="text-6xl font-extrabold leading-tight">We Build Brands<br/>That Matter</h1>
        ...
        <section className="px-6 py-20">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl font-extrabold text-zinc-900 leading-tight mt-2">From a Vision to a<br/>Full-Scale Digital Agency</h2>
        ...
        <section className="px-6 py-20 bg-white">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            <motion.div
              className="bg-gradient-to-br from-[#1e3a5a] to-[#0a2540] text-white p-10 rounded-3xl"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              whileHover={{ y: -4 }}
            ...
            <motion.div
              className="bg-gradient-to-br from-amber-400 to-amber-500 text-zinc-900 p-10 rounded-3xl"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
        ...
        <section className="px-6 py-20">
          ...
          >
            ...
            <h2 className="text-4xl font-extrabold text-zinc-900 mt-2">The Road to 1000+ Projects</h2>
          </motion.div>
        ...
        <section className="px-6 py-20 bg-white border-t border-zinc-100">
          ...
          >
            ...
            <h2 className="text-4xl font-extrabold text-zinc-900 mt-2">Our Core Values</h2>
          </motion.div>
