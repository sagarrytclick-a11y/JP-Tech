    ...
    <footer className="bg-[#0a1a2e] text-white">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-5">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold">JP <span className="text-amber-400">Technologies</span></span>
            </Link>
            ...
            <div className="space-y-3 text-sm text-zinc-400">
              <Link href="mailto:contact@batterseawebexpert.com" className="flex items-center gap-3 hover:text-white transition-colors group">
              ...
              <Link href="tel:+918826916476" className="flex items-center gap-3 hover:text-white transition-colors group">
      ...
      <div className="px-6 py-6 border-t border-zinc-800/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-zinc-500">
          <p>© {new Date().getFullYear()} JP Technologies. All rights reserved.</p>
